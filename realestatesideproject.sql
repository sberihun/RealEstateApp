...
create table agent_property(
	...
	constraint agent_property_constraint primary key (agent_number, property_number),
	...
	constraint FK_agent_property_closing foreign key (closing_date) references property (closing_date)
